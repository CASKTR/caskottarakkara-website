...
const facultyMembersData = [
  {
    ...
    qualifications: 'Ph.D. CSE, M.Tech',
    phone: '+91-9876543211',
    email: 'hod.cse@cas.edu.in',
    achievements: ['15+ years experience', '30+ publications'],
    image: 'https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=400'
  },
  {
    name: 'Dr. Meera Srinivasan',
    department: 'Electronics & Communication',
    qualifications: 'Ph.D. ECE, M.Tech',
    phone: '+91-9876543212',
    email: 'hod.ece@cas.edu.in',
    achievements: ['12+ years experience', 'Best Teacher Award'],
    image: 'https://images.pexels.com/photos/3727464/pexels-photo-3727464.jpeg?auto=compress&cs=tinysrgb&w=400'
  },
  {
    name: 'Dr. Arun Pillai',
    department: 'Information Technology',
    qualifications: 'Ph.D. IT, M.Tech',
    phone: '+91-9876543213',
    email: 'hod.it@cas.edu.in',
    achievements: ['18+ years experience', 'Industry collaborations'],
    image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=400'
  }
];

const FacultyMembersPage: React.FC = () => {
      ...
      <section className="pt-[155px] md:pt-[170px] lg:pt-[185px] bg-gradient-to-br from-blue-800 to-indigo-950 text-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
          <div className="flex items-center text-sm text-white/80 mb-3">
            ...
            <span className="text-white">Faculty Members</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold">Faculty Members</h1>
          <p className="mt-2 text-white/90 max-w-2xl">Dedicated educators committed to academic excellence.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {facultyMembersData.map((faculty, index) => (
                <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group ring-1 ring-gray-100">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-blue-600 font-semibold mb-2">{faculty.department}</p>
                    <p className="text-gray-600 text-sm mb-4">{faculty.qualifications}</p>
