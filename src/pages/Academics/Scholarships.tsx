    ...
    <div className="bg-orange-50 rounded-3xl shadow-xl ring-1 ring-orange-100 overflow-hidden hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="p-8 bg-blue-50">
        <p className="text-gray-700 mb-6 leading-relaxed">
          The National Scholarship Portal (NSP) is a one-stop platform that
          provides access to a wide range of scholarships offered by the Central
          Government. It brings together various schemes under one umbrella,
          making the application process simple, transparent, and efficient for
  ...
  const KeralaScholarshipCard = () => (
    <div className="bg-white rounded-3xl shadow-xl ring-1 ring-gray-100 overflow-hidden hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="p-8 bg-green-50">
        <p className="text-gray-700 mb-6 leading-relaxed">
          The official e-grantz Kerala portal provides the most up-to-date
          information about state government scholarships and grants. This
          dedicated platform ensures Kerala students have easy access to local
          scholarship opportunities.
        </p>

        <div className="space-y-4 mt-6">
          <h3 className="font-semibold text-gray-900 text-lg mb-2">
            Kerala State Scholarship Programmes
          </h3>
          <div className="p-4 bg-gray-50 rounded-xl space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
    ...
    <div className="bg-white rounded-3xl shadow-xl ring-1 ring-gray-100 p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Special provisions for SC, ST, and OBC categories
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl">
          ...
          <p className="text-sm text-gray-600">
            Eligible for government-mandated fee concessions based on official
            orders
          </p>
        </div>
        ...
        <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl">
          ...
          <p className="text-sm text-gray-600">
            Special tribal community benefits and educational support programs
          </p>
        </div>
        ...
        <div className="text-center p-6 bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl">
          ...
          <p className="text-sm text-gray-600">
            Category-specific concessions and reservation benefits
          </p>
        </div>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <p className="mt-1 text-sm text-yellow-700">
              Eligibility criteria, concession amounts, and application
              procedures can vary depending on the educational institution and
              type of program. Please contact the Academic Office for specific
      ...
      <div className="mt-8 text-center">
        <button
          ...
          onClick={() => {
            navigate("/information/contactus");
      ...
      <section className="pt-[155px] md:pt-[170px] lg:pt-[185px] bg-gradient-to-br from-blue-800 to-indigo-950 text-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12">
          ...
          <p className="mt-2 text-white/90 max-w-2xl">
            Explore the various scholarships available to support your academic
            journey.
          </p>
        </div>
      </section>
