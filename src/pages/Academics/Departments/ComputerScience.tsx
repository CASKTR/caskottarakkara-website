      ...
      <section className="pt-[155px] md:pt-[170px] lg:pt-[185px] bg-gradient-to-br from-blue-800 to-indigo-950 text-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
          ...
          <p className="mt-2 text-white/90 max-w-2xl">
            Leading innovation in technology education and research
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 space-y-16">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      The Department of Computer Scienceis a premier center for
                      technology education and research. Established with the
                      vision to create future-ready professionals, we offer
                      cutting-edge curriculum that combines theoretical
                      foundations with practical applications.
                    </p>
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      Our department is committed to fostering innovation,
                      creativity, and critical thinking among students. With
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To be a center of excellence in computer science education
                    and research, producing innovative professionals who
                    contribute to technological advancement and societal
                    development.
                  </p>
                </div>
                <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To provide high-quality education, foster research and
                    innovation, develop ethical professionals, and create
                    solutions for real-world challenges through cutting-edge
          ...
          <section id="faculty">
            ...
            <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {facultyDataJson.computersciencefaculty.map(
                  (computersciencefaculty: any, index: number) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="relative">
                        <img
                          src={computersciencefaculty.image}
                          alt={computersciencefaculty.name}
                      ...
                      <div className="p-6">
                        <h3 className="text-xl font-bold text-gray-900 mb-1">
                          {computersciencefaculty.name}
                        </h3>
                        <p className="text-blue-600 font-semibold mb-2">
                          {computersciencefaculty.designation}
                        </p>
                        <p className="text-gray-600 text-sm mb-3">
                          {computersciencefaculty.qualifications}
                        </p>

                        <div className="space-y-2 border-t pt-4">
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            <Mail className="h-4 w-4 text-blue-500" />
                            <span>{computersciencefaculty.email}</span>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <section id="achievements">
            ...
            <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {studentAchievementsJson.computersciencestudents.map(
          ...
          <section id="activities">
            ...
            <div className="space-y-6 mb-8">
              {departmentActivitiesJson.computerscienceactivities.map(
                (activity, index) => (
                  <div
                    key={index}
