      ...
      <section className="pt-[155px] md:pt-[170px] lg:pt-[185px] bg-gradient-to-br from-blue-800 to-indigo-950 text-white">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-10">
          ...
          <p className="mt-2 text-white/90 max-w-2xl">
            Shaping excellence in commerce education and research{" "}
          </p>
        </div>
      </section>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The Department of Commerce envisions becoming a premier hub
                    for commerce and business education, producing globally
                    competent professionals and entrepreneurs who drive economic
                ...
                <div className="rounded-3xl bg-white shadow-xl ring-1 ring-gray-100 p-6 md:p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    The mission of the department is to provide a holistic
                    learning experience in commerce and management, nurturing
                    analytical thinking, entrepreneurial spirit, and ethical
                    values. Through academic excellence and strong industry
                    connections, the department strives to prepare students for
                    leadership roles in the dynamic business environment.
                  </p>
                </div>
              </div>
            </div>
